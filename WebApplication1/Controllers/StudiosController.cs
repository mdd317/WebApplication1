    ...
    public class StudiosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Studios != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Studios'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Studio_Name,Owner")] Studio studio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Studio_Name,Owner")] Studio studio)
        {
            if (id != studio.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.Studios'  is null.");
            }
            var studio = await _context.Studios.FindAsync(id);
            if (studio != null)
            {
